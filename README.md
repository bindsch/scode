...
> **Beta software (v0.3.0).** This is under active development. Defaults may change, features may break, and sandbox coverage is not guaranteed to be complete. Use at your own risk. Pull requests welcome.
...
```bash
EXPECTED_COMMIT="2bfbc62b4dc048c32246623be3e5d7f3a4a1117b" # v0.3.0
...
```bash
COMMIT="2bfbc62b4dc048c32246623be3e5d7f3a4a1117b" # v0.3.0
tmp="$(mktemp -d)"
...
(cd "$tmp" && printf '%s  %s\n' \
  f8bf071004de2df5878ca4bc1b472cee75dcc213ce4bb481a0bf75e638d3e6b5 scode \
