...
```bash
EXPECTED_COMMIT="d1d9e0fd3a53dddeb9af37aff26da49bc181d4ee" # v0.3.1
...
```bash
COMMIT="d1d9e0fd3a53dddeb9af37aff26da49bc181d4ee" # v0.3.1
tmp="$(mktemp -d)"
...
(cd "$tmp" && printf '%s  %s\n' \
  7bf4cbbc7ea2500ac7e6ed901498ce3832c1748d8278135a90afcca1d11b0f0d scode \
